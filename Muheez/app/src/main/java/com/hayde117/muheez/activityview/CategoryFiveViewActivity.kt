...
import com.hayde117.muheez.databinding.ActivityCategoryFiveViewBinding

class CategoryFiveViewActivity : AppCompatActivity() {


    private lateinit var binding: ActivityCategoryFiveViewBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCategoryFiveViewBinding.inflate(layoutInflater)
