...
import com.hayde117.muheez.databinding.ActivityCategoryTwoViewBinding

class CategoryTwoViewActivity : AppCompatActivity() {




    private lateinit var binding: ActivityCategoryTwoViewBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCategoryTwoViewBinding.inflate(layoutInflater)
